...
function addMember(q) {
    ...
    var newrow = $("#member" + selectedRole).append(
        '<tr id="memRow' +
            memRow +
            '"><td style="display: none;"><input name="roles_position[]"" value="'+selectedRole+'" /></td><td><input class="form-control" readonly name="roles_name[]" id="name-' +
            q +
            "-" +
            selectedRole +
            '" value="' +
            ...
            memRow +
            '"></td><td><input class="form-control" name="roles_description[]" readonly value="' +
            desig +
            '"></td><td><button type="button" name="addRole" onclick="removeMember(\'' +
            memRow +
            "','" +
            q +
            "','" +
            selectedRole +
            '\')" class="btn btn-danger shadow btn-circle btn-sm"><i class="fas fa-minus"></i></button></td></tr>'
    );
    $("#row-" + q).hide();
    memRow++;
}
...
function addCustomMember(q) {
    var newrow = $("#member" + q).append(
        '<tr id="memRow' +
            memRow +
            '"><td style="display: none;"><input name="roles_position[]"" value="'+selectedRole+'" /></td><td><input class="form-control" name="roles_name[]" id="name-0-' +
            q +
            '" name="representative_' +
            memRow +
            '"></td><td><input class="form-control" name="roles_description[]"></td><td><button type="button" name="addRole" onclick="removeCustomMember(`' +
            memRow +
            "`, `" +
            q +
            '`)" class="btn btn-danger shadow btn-circle btn-sm"><i class="fas fa-minus"></i></button></td></tr>'
...
function addResponsibility(q, u) {
    ...
    var newrow = $("#added_responsibility_list_" + u).append(
        '<tr id="responsibility_row_' +
            responbilityRow +
            '"><td style="display: none;"><input name="responsibilities_position[]" value="'+u+'"/></td><td><input class="form-control" name="responsibilities[]" readonly id="responsibility_description_' +
            q +
            "_" +
            u +
            '" value="' +
            responsibility_description +
            '"></td><td><button type="button" class="btn btn-danger shadow btn-circle btn-sm" onclick="removeResponsibility(\'' +
            responbilityRow +
            "', '" +
            q +
            "', '" +
...
function addCustomResponsibility(q) {
    var newrow = $("#added_responsibility_list_" + q).append(
        '<tr id="responsibility_row_' +
            responbilityRow +
            '"><td style="display: none;"><input name="responsibilities_position[]" value="'+q+'"/></td><td><input class="form-control" name="responsibilities[]" id="responsibility_description_0_' +
            q +
            '"></td><td><button type="button" class="btn btn-danger shadow btn-circle btn-sm" onclick="removeCustomResponsibility(' +
            responbilityRow +
            ')"><i class="fas fa-minus"></i></button></td></tr>'
    );
    responbilityRow++;
