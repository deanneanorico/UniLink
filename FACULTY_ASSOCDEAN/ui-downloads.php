        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h6 class="card-title font-weight-bold mb-2">Downloads</h6>
                    <div class="card">
                        <div class="card-body">
                            <div>
                                <!-- Provide a link to navigate to the PDF view page -->
                                <a href="pdf_view.php" style="color: #FF5733;">
                                    <i class="fa fa-file-pdf" style="color: #000;"></i> MOA
                                </a>
                            </div>
                            <div>
                            <a href="pdf_view.php" style="color: #FF5733;">
