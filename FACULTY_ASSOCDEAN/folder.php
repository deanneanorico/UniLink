            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <i class="fas fa-plus"></i> Create Folder </a>
                            </a>
                        </div>
                    </div>
                </div>
              ...
              <?php
                // $sql = "SELECT * FROM create_folder WHERE category = 'local' ORDER BY id DESC";
                ...
                ?>
                        <!-- <div class="col-md-2">
                            <div class="folder" oncontextmenu="showContextMenu(event, <?php echo $row['id']; ?>)">
                                <a href="docu_ local.php?id=<?=$row['id']?>">
                                    <img src="../imgs/bsu_folder.png" style="width:130px">  
                                </a>
                                <div class="card-footer" style="width: 90px; max-height: 50px; overflow: hidden; padding: 10px 10px 10px 10px; text-align: center;"><?php echo $row["createfolder"] ?></div>
                            </div>
                        </div> -->
                <?php
                //     }
