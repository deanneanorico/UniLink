...
<body id="page-top">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex">
            <a class="btn btn-primary rounded-fill" data-toggle="modal" data-target="#upload"> <!-- Update modal ID here -->
...
<div class="modal fade" id="upload" tabindex="-1" role="dialog" aria-labelledby="addmodallabel" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Form Fields -->
            <form enctype="multipart/form-data" action="<?php if (isset($_GET['id'])) {echo "nested.create.folder.php";} else {echo "create.folder.php";}?>" method="post">
                <!-- Replace "insert_campus.php" with the actual path to your server-side script -->
                <div class="modal-body">
                    <div class="form-group">
                        <label for="createfolder">Name</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" value="upload" class="btn btn-primary" name="create_folder">Upload</button>
                </div>
            </form>
            <!-- Form ends -->
        </div>
