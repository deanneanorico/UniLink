                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title" value="<?=$user_data['title']?>">          
                        </div>
                       </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="input2">First Name</label>
                        <input type="text" class="form-control" id="first" name="first" value="<?=$user_data['first_name']?>">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="input3">Middle Initial</label>
                        <input type="text" class="form-control" id="middle" name="middle" value="<?=$user_data['mid_name']?>">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="input4">Last Name</label>
                        <input type="text" class="form-control" id="last" name="last" value="<?=$user_data['last_name']?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group sex">
                        ...
                        <select class="form-control" id="campus" name="campus" onchange="setDepartment()">
                            ...
                            ?>
                              <option value="<?=$row['campus_name']?>" <?php if($user_data['campus'] == $row['campus_name']){echo "selected";}?>><?=$row['campus_name']?></option>
                            <?php
                              }
                            ?>
                          </select>
